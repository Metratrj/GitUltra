...
impl<'a> Commit<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.oid { builder.add_oid(x); }
    builder.finish()
  }
  ...
  pub fn oid(&self) -> &'a str {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Commit::VT_OID, None).unwrap()}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CommitBuilder<'a, 'b, A> {
  ...
  pub fn add_message(&mut self, message: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Commit::VT_MESSAGE, message);
  }
  #[inline]
  pub fn add_author(&mut self, author: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Commit::VT_AUTHOR, author);
  }
  #[inline]
...
#[inline]
pub fn finish_size_prefixed_commit_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<Commit<'a>>) {
